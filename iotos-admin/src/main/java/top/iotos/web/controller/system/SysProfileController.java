...
import top.iotos.common.utils.file.FileUploadUtils;
import top.iotos.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends MyBaseController
{
    @Autowired
    ...
    public AjaxResult updatePwd(String oldPassword, String newPassword)
    {
        ...
        if(userName.equals("iotos")){
            return error("演示账号不允许修改密码！感谢配合！");
        }
