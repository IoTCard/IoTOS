...
import top.iotos.common.core.page.TableDataInfo;
...
import top.iotos.common.utils.poi.ExcelUtil;
import top.iotos.system.service.ISysDeptService;
import top.iotos.system.service.ISysPostService;
import top.iotos.system.service.ISysRoleService;
...
public class SysUserController extends MyBaseController
{
    ...
    @PreAuthorize("@ss.hasPermi('system:user:list')")
    @PostMapping(value = "/setLg", produces = { "application/json;charset=UTF-8" })
    public String setLg(@RequestBody String pwdStr)
    {
        try {
            HashMap<String, Object> parameter =  getParameter(pwdStr);
            String lgCode = parameter.get("lgCode").toString();
    ...
    public String findDeptUser(@RequestBody String pwdStr)
    {
        try {
            HashMap<String, Object> parameter =  getParameter(pwdStr);
