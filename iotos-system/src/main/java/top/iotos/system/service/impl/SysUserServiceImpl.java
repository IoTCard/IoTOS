...
import top.iotos.common.utils.bean.BeanValidators;
import top.iotos.common.utils.spring.SpringUtils;
import top.iotos.system.domain.SysPost;
import top.iotos.system.domain.SysUserPost;
import top.iotos.system.domain.SysUserRole;
import top.iotos.system.mapper.SysPostMapper;
import top.iotos.system.mapper.SysRoleMapper;
import top.iotos.system.mapper.SysUserMapper;
import top.iotos.system.mapper.SysUserPostMapper;
import top.iotos.system.mapper.SysUserRoleMapper;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    @Override
    public boolean setLg(SysUser user) {
        return userMapper.updateUserlanguageCode(user)>0;
    }

    @Override
    public List<Map<String, Object>> findDeptUser(Map map) {
