    ...
    public void execution(Map<String, Object> pMap,Map<String, Object> map,Map<String,Object> user,String deptId){
        ...
        if(exportArr!=null && exportArr.size()>0){
            ...
            if(deptId.equals("100")){
                ...
                outcolumns = new String[]{"自定义编号","MSISDN","ICCID","IMSI","IMEI","激活时间","所属企业","通道编号","卡状态","资费总量-和","资费已用流量-和","资费剩余用量-和","创建时间","用量同步时间","状态同步时间","是否实名","是否需要实名","卡类型","网络类型","是否支持短信发送","是否支持语音功能","短信服务号","发货日期","服务-生效时间","服务-失效时间","出库日期","自定义分组","备注","资费组编号","是否自动续费","用卡人编号","漫游国家","网络信号","ip归属地","运营商"};
