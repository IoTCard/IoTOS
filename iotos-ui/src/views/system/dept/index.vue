  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      ...
      <el-form-item :label="$t('common.state')" prop="status">
        <el-select v-model="queryParams.status" placeholder="企业状态" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        ...
        >{{ $t('common.expand_collapse') }}</el-button>
      </el-col>
    ...
    >
      ...
      <el-table-column prop="dname" label="企业简称" width="260"></el-table-column>
      <el-table-column prop="orderNum" label="排序" width="200"></el-table-column>
      <el-table-column prop="status" :label="$t('common.state')" width="100">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="企业简称" prop="dname">
              <el-input v-model="form.dname"  placeholder="请输入企业简称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
